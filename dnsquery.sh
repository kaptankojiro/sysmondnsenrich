...
rm sonuc1.csv
echo DomainName,EntropyResult[1],EntropyResult[2],RegistrationDate,UpdatedDate,AlexaWordCount,IP,Region,City > sonuc1.csv
...
output10=($(echo https://otx.alienvault.com/indicator/domain/$line ))
output11=($(echo https://www.threatcrowd.org/domain.php?domain=$line ))


echo $line,"${output[0]}""${output[1]}","$output2[0]","${output3[0]}","${output4[0]},${output5[0]},${output6[0]},${output7[0]},${output8[0]},${output9[0]},${output10[0]},${output11n[0]}"|  tr -d ')' | tr -d '(' >> sonuc1.csv
done < "$input"
cat sonuc1.csv
